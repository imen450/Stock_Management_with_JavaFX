...
public class UpdateFournisseur implements Initializable {
...
private TextField txt5;
    ...
    private void update(ActionEvent e) throws IOException, ClassNotFoundException, SQLException
    {
     ...
     try {
          String sql2="update Fournisseur set nom_prenomf='"+txt1.getText()+"',telf='"+txt2.getText()+"', emailf='"+txt3.getText()+"',adressf='"+txt4.getText()+"',villef='"+txt5.getText()+"' where id_fourni='"+txt11.getText()+"'";
...
private void Retourner(ActionEvent e) throws IOException
    {
        ...
        Parent root3;
        root3 = FXMLLoader.load(getClass().getResource("/Views/fournisseur.fxml"));
